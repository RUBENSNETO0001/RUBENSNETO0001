# Olá, eu sou o Rubens Neto 👋

Sou apaixonado por criar e desenvolver programas e sistemas, com foco em soluções robustas e eficientes. Atualmente, dedico-me a projetos Full-Stack e à exploração de novas tecnologias.
...
<div style="display: flex; flex-direction: row; justify-content: center; align-items: center; gap: 10px; flex-wrap: wrap;">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/ubuntu/ubuntu-original.svg" alt="Ubuntu" height="30" width="40">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original-wordmark.svg" alt="GitHub" height="30" width="40">
</div>
